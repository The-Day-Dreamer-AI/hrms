...
export function DataTablePagination<TData, TValue>() {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse items-start md:items-center justify-between px-2 gap-4">
      <div className="flex-1 text-sm text-muted-foreground whitespace-nowrap">
        {table.getFilteredSelectedRowModel().rows.length} of{" "}
        {table.getFilteredRowModel().rows.length} row(s) selected.
      </div>
      <div className="flex items-center space-x-6 lg:space-x-8 justify-between md:justify-end w-full">
