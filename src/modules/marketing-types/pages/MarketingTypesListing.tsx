...
export function MarketingTypesListing() {
    ...
    return (
        <div className="h-full flex-1 flex-col space-y-4 md:flex">
            <ListingHeader
                ...
                description="Manage your marketing claim types here."
                onAddButtonClicked={() => navigate("/marketing-types/create?mode=create")}
            ...
            <div className="h-full flex-1 flex-col space-y-2 md:flex">
                ...
                >
                    <DataTableToolbar
                        ...
                        searchBarPlaceholder="Search Marketing Claim Name"
                    />
                    <DataTable/>
                    <DataTablePagination/>
                </DataTableProvider>
